...
def fetch_mirna_tables(lookup_results: Dict[str, Dict[str, pl.DataFrame]], tmp_dir_path: str = "tmp") -> List[str]:
    """
    ...
    if missing_files:
        ...
        print(f"Downloading {len(missing_files)} missing miRNA files to {local_dir}")
