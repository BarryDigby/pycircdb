...
> pycircdb was designed to bring traditional GUI 'point-and-click' circRNA databases to the command line, facilitating its use in computational workflows. pycircdb is lightweight - requiring only 4.2 GB of disk space when the full parquet database is downloaded.  
